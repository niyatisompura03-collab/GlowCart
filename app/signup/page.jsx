            ...
            <div className="max-w-md w-full space-y-8 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl p-8 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-800 z-10 relative">
                <div className="text-center">
                    ...
                    <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                        Join GlowCart today for a better experience
                    </p>
                </div>
                ...
                <div className="text-center mt-6">
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <Link href="/login" className="font-bold text-primary hover:text-primary-hover transition-colors underline underline-offset-4">
                            Sign in here
                        </Link>
                    </p>
                </div>

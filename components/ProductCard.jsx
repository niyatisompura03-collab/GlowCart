...
const ProductCard = ({ product }) => {
    ...
    return (
        ...
        >
            <div className="cursor-pointer relative bg-gray-500/10 rounded-lg w-full h-52 sm:h-64 flex items-center justify-center overflow-hidden transition-colors">
                <Image
                    src={product.image[0]}
                    alt={product.name}
                    className="group-hover:scale-110 transition duration-500 object-cover w-4/5 h-4/5 md:w-full md:h-full mix-blend-multiply"
                    width={800}
                    height={800}
                />
            </div>
            ...
            <div className="w-full mt-2">
                ...
                <p className="w-full text-xs text-gray-500 max-sm:hidden truncate mt-0.5">{product.description}</p>
